...
impl PlatformIcon {
    ...
    pub fn to_nsimage(&self, fixed_height: Option<f64>) -> Retained<NSImage> {
        ...
        // DSH local patch: custom menu-item icons are drawn as black+alpha
        // glyphs; without the template flag macOS would render them raw
        // (black-on-black in dark menus). Template images are tinted
        // monochrome automatically per menu appearance, light and dark.
        unsafe { nsimage.setTemplate(true) };
