...
- [ ] 1.6 Verify; bump patch to 0.1.56; commit
...
- [ ] 3.1 Tests + cargo check pass
- [ ] 3.2 Release build + deploy to /Applications (relaunch; keep app running)
- [ ] 3.3 Confirm v0.1.56 live and new table UX renders