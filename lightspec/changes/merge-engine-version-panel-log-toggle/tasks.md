## 1. Tray menu icons (v0.1.51)
- [x] 1.1 Replace the switch-style glyph with the gear SF Symbol on the target menu item
- [x] 1.2 "Open in Browser" uses the arrow.up.right.square glyph
- [x] 1.3 Engine card "open in browser" globe -> arrow.up.right.square
